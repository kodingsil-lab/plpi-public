        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <label class="span-2">
                    ...
                    <small>Placeholder: {judul}, {jurnal}, {link jurnal}, {pernyataan komitmen penulis}.</small>
                </label>
            </div>
        </div>

        <div class="form-actions">
            <a class="admin-btn secondary" href="<?= site_url('dashboard/messages/templates') ?>">Kembali</a>
